...
<button class="md:w-1/4 md:p-5 md:border md:rounded-md">
...
<!-- Modal -->
<Dropdown bind:open={isShowDropdown} class="md:w-80">
  <div>
    ...
    {:else}
      <div class="md:px-3 md:py-5 md:flex md:flex-col md:items-center md:gap-1">
