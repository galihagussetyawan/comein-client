...
<div class="md:w-1/4 md:p-5 md:border md:rounded-md" on:click={toggleModal}>
  ...
  <p class=" md:text-[0.8rem] md:font-light">Viewing account</p>
</div>

<!-- Modal -->
{#if isShowModal}
  <div class="md:w-1/4 md:relative md:top-2">
    <div
      class="md:w-full md:absolute md:shadow-2xl md:rounded-md md:border md:bg-white"
    >
